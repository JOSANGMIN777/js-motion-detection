...
The app uses WebRTC, HTML5 Canvas and some math, and is refactored out of the [Magic Xylophone](https://soundstep.github.io/magic-xylophone/app/index.html)) by [soundstep](https://github.com/soundstep).
